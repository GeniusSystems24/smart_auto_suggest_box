    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // ── 8. Multi-Select Basic ───────────────────────────────────
          sectionHeader(
            context,
            title: '8. Multi-Select (Basic)',
            subtitle:
                'Select multiple fruits. Selected items appear as chips '
                'below the field. Max 3 chips visible; tap "Show all" '
                'to see the rest.',
          ),
          const SizedBox(height: 8),
          ...
          // ── 9. Multi-Select with Max Selections ─────────────────────
          sectionHeader(
            context,
            title: '9. Multi-Select (Max 5)',
            subtitle:
